#!/bin/sh
#   Compilation/Execution du jar executable Serveur_Java_TCP_Socket : Serveur TCP, utilisant les sockets en java
#
...
while true;do
	#Compilation et Execution du programme Serveur_Java_TCP_Socket
	echo
	echo
